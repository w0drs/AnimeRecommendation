...
Датасет содержит 28 фичей и около 29 тысяч объектов. После обработки данных число аниме сократилось до 25 тысяч, т.к в убранных объектах не было описания. Из фичей оставил, на мой взгляд, только 10 полезных.  
